...
open BETTER,'>',"/data/output/smsnpMapper_out/Better_enzyme_site.txt";
...
close BETTER;
open ENZYME,'>',"/data/output/smsnpMapper_out/Enzyme_site.txt";
foreach (@enzyme) {
	chomp;
...
#system "cp -r Better_enzyme_site*.txt /data/output/";
#system "cp -r Enzyme_site*.txt /data/output/";
my $time2 = time;
